...
/*DEVUELVE EL REPORTE DE TODOS LOS MECANICOS PERO SIN EL ID_MEC*/
...
/*REPORTE TODOS LOS MECANICOS CONSULTA FINAL
 *repite los datos de los empleados que tienen más de un ID, 
 ¡¡IGNORAR LOS ID'S QUE FINALIZAN CON 0!! */
SELECT mecanicos_suc.id_mec, mecanicos_suc.nombre,
(select SUM(destajo_por_fecha_1.ttr)
FROM destajo_por_fecha_1 JOIN mecanicos on mecanicos.id_mec = destajo_por_fecha_1.id_mec
WHERE destajo_por_fecha_1.fecha_fact BETWEEN '2022-04-01' AND '2022-04-30'
...
*/
Select mecanicos_suc.id_mec, mecanicos_suc.nombre, destajo_por_fecha_1.no_orden, 
